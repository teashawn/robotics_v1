...
class ContinuousSubprocess:
	...
	def terminate(self) -> None:
		...
		# Credit: https://stackoverflow.com/a/4791612
...
def get_joint_states_subscriber():
	return ContinuousSubprocess(CMD)
